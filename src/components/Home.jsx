    ...
    <div name="home" className='page-1 w-full h-screen bg-gradient-to-b from-black via-black to-gray-800'>
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center md:justify-between h-full px-4 md:flex-row md:gap-40 z-10'>
        <div className='flex flex-col pt-20 justify-center w-full mb-0 h-full'>
          ...
          <p className='text-gray-300 py-2 text-lg max-w-md md:my-6 md:leading-7 text-justify z-10'>
          ...
          <div className='flex gap-6'>
            ...
            <a href={cv} className='z-10' download="Aman_2024.pdf">
              <button onClick={handleCvDownload} className='btn group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-blue-500 to-cyan-500 cursor-pointer z-10'>
